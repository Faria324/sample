...
const Banner = () => {
  ...
  return (
    <div className='flex rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 '   style={{ backgroundColor: '#696FC7' }}    >
       {/**------left side----- */}
       ...
       <div  className='hidden md:block md:w-1/2 lg:w-92.5 relative'  >
        <img className='w-full absolute bottom-0 right-0 max-w-md'     src={assets.appointment_img}  alt="doctor image" />
       </div>
